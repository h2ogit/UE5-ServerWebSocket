 ...
 **/
class SERVERWEBSOCKET_API FNetWebSocketHttpMount
{
public:
...
class SERVERWEBSOCKET_API IServerWebSocket
{

public:

	virtual ~IServerWebSocket() {}
	 ...
	 */
	virtual void EnableHTTPServer(TArray<FNetWebSocketHttpMount> DirectoriesToServe) = 0;
	 ...
	 */
	virtual bool Init(uint32 Port, FNetWebSocketClientConnectedCallBack ClientConnectedCallback) = 0;
